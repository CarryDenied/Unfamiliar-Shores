...
namespace ACE.Server.WorldObjects
{
    public class AugmentationDevice: WorldObject
    {
        ...
        public static Dictionary<AugmentationType, int> MaxAugs = new Dictionary<AugmentationType, int>()
        {
            ...
            { AugmentationType.CritChance, 2 },
            { AugmentationType.CritDamage, 2 },
            { AugmentationType.Melee, 5 },
            { AugmentationType.Missile, 5 },
            { AugmentationType.Magic, 5 },
            { AugmentationType.Damage, 2 },
            { AugmentationType.DamageResist, 2 },
            { AugmentationType.AllStats, 2 },
