                ...
                else
                {
                    ...
                    if (Damage < 7)
                    {
                        ...
                        actionChain.AddAction(player, () =>
                        {
                            ...
                            player.EarnXP((int)(((-Level ?? -1) - 1000) * (PropertyManager.GetDouble("exploration_bonus_xp").Item + 0.5)), XpType.Exploration, null, null, 0, null, ShareType.None, msg);
                    ...
                    else
                    {
                        ...
                        actionChain.AddAction(player, () =>
                        {
                            ...
                            var level = Math.Min(player.Level ?? 1, Level ?? 1);
                            player.EarnXP((int)(((-Level ?? -1) - 1000) * (PropertyManager.GetDouble("exploration_bonus_xp").Item + 0.5)*3), XpType.Exploration, null, null, 0, null, ShareType.None, "You unearth a treasure chest!");
